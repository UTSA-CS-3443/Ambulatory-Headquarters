...
/**
 * This class handles the processing of each level, including loading the level
 * and spawning entities. It also handles movement.
 * 
...
public class Map {
	 ...
	 * @param c1
	 *            target column
	 * @return 0 if current is same with target, 2 if target is an Unit, 1 if move
	 *         was successful, 3 is too far
	 */
